...
public class Roofs {
    ...
    public static List<Roof> roofs(final CoreSprites sprites, final List<Line2D> lines) {
        final List<Roof> r = new ArrayList<Roof>();
        for (Line2D line : lines) {
            r.add(new DefaultRoof(sprites.roofTexture(), line.x1, line.z1, line.x2, line.z2));
        }
        return r;
    }
}
